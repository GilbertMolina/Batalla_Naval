...
public class PonerNavesJugador {
    ...
    public static void ponerTodasLasNavesJugador(){
        JOptionPane.showMessageDialog(null, idj.getNombreUsuario()+", debe digitar un numero entre 1 y 10, tanto para filas y columnas", "Colocación de barcos", JOptionPane.INFORMATION_MESSAGE);
        for(int i=0; i<4; i++){
            ponerSubmarino();
        ...
        do {
            do {
                ...
                if(mu.validarSiEsNumero(auxValidacionFilaInterna)==true){
                    ...
                    if (filaMovimientoJugador<1 || filaMovimientoJugador>10) {
                        JOptionPane.showMessageDialog(null, idj.getNombreUsuario()+", debe digitar un número entre 1 y 10 para colocar "+pMensaje, "Atención", JOptionPane.INFORMATION_MESSAGE);
                    }
                }else{
                    JOptionPane.showMessageDialog(null, idj.getNombreUsuario()+", debe digitar un número entre 1 y 10 para colocar "+pMensaje, "Atención", JOptionPane.INFORMATION_MESSAGE);
                }
            } while (filaMovimientoJugador<1 || filaMovimientoJugador>10);
            ...
            do {
                ...
                if(mu.validarSiEsNumero(auxValidacionColumnaInterna)==true){
                    ...
                    if (columnaMovimientoJugador<1 || columnaMovimientoJugador>10) {
                        JOptionPane.showMessageDialog(null, idj.getNombreUsuario()+", debe digitar un número entre 1 y 10 para colocar "+pMensaje, "Atención", JOptionPane.INFORMATION_MESSAGE);
                    }
                }else{
                    JOptionPane.showMessageDialog(null, idj.getNombreUsuario()+", debe digitar un número entre 1 y 10 para colocar "+pMensaje, "Atención", JOptionPane.INFORMATION_MESSAGE);
                }
            } while (columnaMovimientoJugador<1 || columnaMovimientoJugador>10);
