...
public class CombateJugador {
    ...
    public static void generarAtaqueJugador(){
        ...
        if(idj.getObtenerNivelDificultad()==0){
            atacarAComputadoraFacil(filaAtaqueDeJugador, columnaAtaqueDeJugador);
        }else if(idj.getObtenerNivelDificultad()==1){
            atacarAComputadoraDificil(filaAtaqueDeJugador, columnaAtaqueDeJugador);
        }
        ...
        do {
            do {
                ...
                if(mu.validarSiEsNumero(auxValidacionFilaInterna)==true){
                    ...
                    if (filaAtaqueDeJugador<1 || filaAtaqueDeJugador>10) {
                        JOptionPane.showMessageDialog(null, idj.getNombreUsuario()+", debe digitar un número entre 1 y 10 para atacar al enemigo", "Atención", JOptionPane.INFORMATION_MESSAGE);
                    }
                }else{
                    JOptionPane.showMessageDialog(null, idj.getNombreUsuario()+", debe digitar un número entre 1 y 10 para atacar al enemigo", "Atención", JOptionPane.INFORMATION_MESSAGE);
                }
            } while (filaAtaqueDeJugador<1 || filaAtaqueDeJugador>10);
            ...
            do {
                ...
                if(mu.validarSiEsNumero(auxValidacionColumnaInterna)==true){
                    ...
                    if (columnaAtaqueDeJugador<1 || columnaAtaqueDeJugador>10) {
                        JOptionPane.showMessageDialog(null, idj.getNombreUsuario()+", debe digitar un número entre 1 y 10 para atacar al enemigo", "Atención", JOptionPane.INFORMATION_MESSAGE);
                    }
                }else{
                    JOptionPane.showMessageDialog(null, idj.getNombreUsuario()+", debe digitar un número entre 1 y 10 para atacar al enemigo", "Atención", JOptionPane.INFORMATION_MESSAGE);
                }
            } while (columnaAtaqueDeJugador<1 || columnaAtaqueDeJugador>10);
    ...
    public static void atacarAComputadoraFacil(int pFilaAtaque, int pColumnaAtaque){
